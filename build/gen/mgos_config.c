...
const struct mgos_conf_entry mgos_config_schema_[171] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .num_desc = 170},
  {.type = CONF_TYPE_OBJECT, .key = "device", .num_desc = 5},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "location", .num_desc = 2},
