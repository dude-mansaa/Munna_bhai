 ...
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/fwbuild-volumes/2.3/apps/mansaa/esp32/build_contexts/build_ctx_866705064/build/gen/ /mongoose-os/fw/src/mgos_debug_udp_config.yaml /mongoose-os/fw/src/mgos_sys_config.yaml /mongoose-os/fw/platforms/esp32/src/esp32_sys_config.yaml /fwbuild-volumes/2.3/apps/mansaa/esp32/build_contexts/build_ctx_866705064/build/gen/mos_conf_schema.yml
 */
...
void mgos_config_set_device_location_lat(struct mgos_config *cfg, double      val);
void mgos_config_set_device_location_lon(struct mgos_config *cfg, double      val);
...
static inline void mgos_sys_config_set_device_location_lat(double      val) { mgos_config_set_device_location_lat(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_device_location_lon(double      val) { mgos_config_set_device_location_lon(&mgos_sys_config, val); }
